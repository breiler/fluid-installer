...
function handleURLSelect(evt) {
  ...
  fetch(url, {
    ...
    .then( blob => { evt.target.data = blob; } )
}
...
addURL.onclick = () => {
  ...
  // Column 2 - URL selector
  var cell2 = row.insertCell(1);
  var element2 = document.createElement('input');
  element2.type = 'url';
  element2.id = 'selectURL' + rowCount;
  element2.name = 'selected_URL' + rowCount;
  element2.addEventListener('change', handleURLSelect, false);
  cell2.appendChild(element2);
